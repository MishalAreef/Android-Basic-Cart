...
public class Main2Activity extends AppCompatActivity
{
    ...
    private void StoreProductInformation()
    {
        ...
        loadingBar.setMessage("Dear Admin, Please wait, while we are adding the new products.");
        ...
        ProductsRef.child(productRandomKey).updateChildren(productMap)
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task)
                    {
                        ...
                        if (task.isSuccessful()) {
                            Intent intent = new Intent(Main2Activity.this, AdminCategoryActivity.class);
                            startActivity(intent);

                            loadingBar.dismiss();
                            Toast.makeText(Main2Activity.this, "Product is added Successfully...", Toast.LENGTH_SHORT).show();
                        }
                        else
                            {
                                loadingBar.dismiss();
